...
public class MainApp extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
           try{
             //  FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("Splash.fxml"));
		...
		this.primaryStage = primaryStage;
                String nm=nama.replaceAll(".xml", "");
                
		this.primaryStage.setTitle("AddressApp "+nm);
	...
	public boolean showPersonEditDialog(Person person) {
		try {
			...
			dialogStage.setTitle("Edit Data Siswa");
	...
	public void showBirthdayStatistics() {
	 ...
	 public void showAbout() {
            try {
                ...
                FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("view/dialogFXML.fxml"));
                AnchorPane page = (AnchorPane) loader.load();
                Stage dialogStage = new Stage();
                dialogStage.setTitle("Tentang Editor");
                //dialogStage.initModality(Modality.WINDOW_MODAL);
                dialogStage.getIcons().add(new Image("file:resources/images/about.png"));
			dialogStage.initOwner(primaryStage);
			Scene scene = new Scene(page);
			dialogStage.setScene(scene);
	...
	public void loadPersonDataFromFile(File file) {
		...
		this.primaryStage.setTitle("Biodata Siswa Kelas "+nm);
	...
	public void setPersonFilePath(File file) {
		...
		if (file != null) {
			...
			//this.primaryStage = primaryStage;
                String nm=file.getName().replaceAll(".xml", "").toUpperCase();
                
		//this.primaryStage.setTitle("Biodata Siswa Kelas - "+nm);
			// Update the stage title
			primaryStage.setTitle("Biodata Siswa Kelas - " + nm);
		} else {
			prefs.remove("filePath");
			
			// Update the stage title
			primaryStage.setTitle("Biodata Siswa Kelas");
		}
	}
